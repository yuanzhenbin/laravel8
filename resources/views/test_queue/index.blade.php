        ...
        <div class="layer_div" style="margin-top: 30px;">
            ...
            <div class="div_row" style="margin-top: 30px;">
                ...
                <div class="div_right" style="width: 500px;">
                    <span class="blue_button" id="send">发送</span>
                    <span class="blue_button" id="send_my_queue">发送自定义队列</span>
                    <span class="blue_button" id="get_my_queue">获取自定义队列</span>
                </div>
            </div>
        </div>
    </div>
